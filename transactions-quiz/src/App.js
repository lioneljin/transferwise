...
class App extends Component {
  ...
  renderResult() {
    ...
    const result = (<div>You gave <strong>{this.state.answersCount['Correct']}</strong> correct answers, your discount for the next transfer is <strong>{this.state.answersCount['Correct']*3}%</strong></div>)
    ...
    return (
      <div className="App">
        <div className="App-header">
          ...
          <p>If you pass if faster than we commit your transaction you'll get a discount!</p>
          <Timer
            active={true}
